...
<fieldset>
 <div id="captchaimage"><a href="<?=$_SERVER['PHP_SELF']; ?>" id="refreshimg" title="Click to refresh image"><img src="images/image.php?<?=time(); ?>" width="132" height="46" alt="Captcha image" /></a></div>

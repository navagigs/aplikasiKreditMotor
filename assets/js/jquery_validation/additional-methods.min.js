...
jQuery.validator.addMethod("lettersonly",function(a,b){return this.optional(b)||/^[a-zA-z0-9.-_]+$/i.test(a)},"No Special Characters");jQuery.validator.addMethod("nowhitespace",function(a,b){return this.optional(b)||/^\S+$/i.test(a)},"No white space please");jQuery.validator.addMethod("ziprange",function(a,b){return this.optional(b)||/^90[2-5]\d\{2}-\d{4}$/.test(a)},"Your ZIP-code must be in the range 902xx-xxxx to 905-xx-xxxx");
